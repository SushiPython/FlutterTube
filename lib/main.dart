...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Function() fetchKey = () async {
    ...
    for (var item in response2.data["onResponseRecievedActions"][0]["appendContinuationItemsAction"]["continuationItems"].keys()) {
      developer.log(item["richItemRenderer"]["content"]["videoRenderer"]["title"]["runs"], name: "item");
